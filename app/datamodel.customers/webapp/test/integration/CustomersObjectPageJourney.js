...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check body sections of the Object Page", function (Given, When, Then) {
            Then.onTheCustomersObjectPage.iCheckSection({ section: "Main" });
            Then.onTheCustomersObjectPage.onForm({ section: "Main" }).iCheckField({ property: "email" });
            Then.onTheCustomersObjectPage.onForm({ section: "Main" }).iCheckField({ property: "customerNumber" });
            Then.onTheCustomersObjectPage.onForm({ section: "Main" }).iCheckField({ property: "totalPurchaseValue" });
            Then.onTheCustomersObjectPage.onForm({ section: "Main" }).iCheckField({ property: "totalRewardPoints" });
            Then.onTheCustomersObjectPage.onForm({ section: "Main" }).iCheckField({ property: "totalRedeemedRewardPoints" });
       });
