...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "datamodel/customers/test/integration/FirstJourney",
    "datamodel/customers/test/integration/CustomersListJourney",
    "datamodel/customers/test/integration/CustomersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
