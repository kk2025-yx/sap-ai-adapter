...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "datamodel/purchases/test/integration/FirstJourney",
    "datamodel/purchases/test/integration/PurchasesListJourney",
    "datamodel/purchases/test/integration/PurchasesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
