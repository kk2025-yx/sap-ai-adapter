...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "datamodel/redemptions/test/integration/FirstJourney",
    "datamodel/redemptions/test/integration/RedemptionsListJourney",
    "datamodel/redemptions/test/integration/RedemptionsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
